...
> [小明哥（@mercyblitz）](https://mercyblitz.github.io/about/)：
>
> | 创新者                    | 早期采用者  | 早期大众         | 晚期大众                     |
> | ------------------------- | ----------- | ---------------- | ---------------------------- |
...
[小明哥（@mercyblitz）](https://mercyblitz.github.io/about/)，《Spring Boot 编程思想》作者、Apache Dubbo PMC 和 Spring-Cloud-Alibaba Architect