...
- [python](https://victorfengming.gitee.io/victorfengming_old/2019/08/19/python-install-window/)
- [django](https://victorfengming.gitee.io/victorfengming_old/2019/11/23/django-note1/)
### 集成开发环境的搭建
- webstorm
- pycharm
- 安装参考[这里](https://victorfengming.gitee.io/victorfengming_old/2019/08/16/pycharm-install/),激活破解以及设置,可以在我的[github](https://github.com/victorfengming/jetbrains_settings)/[gitee](https://gitee.com/victorfengming/jetbrains_settings)中clone下来    
## 起步
